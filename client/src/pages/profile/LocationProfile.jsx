...
const LocationProfile = ({ setLoading }) => {
    const { otherLocationsListing, dispatchSearch } = useSearchContext()
    // hooks
    ...
    const toggleWishLocationsList = (index, profileId, profileType) => {
        if (otherLocationsListing[index]?.wishlistProfile) {
            dispatch(deleteWishlistItem(otherLocationsListing[index]?.wishlistItemId))
            let temp = [...otherLocationsListing]
            ...
            <Container>
                ...
                <CurrentDirectorylink className={'my-3'} routeData={[
                    ...
                    },
                    {
                        name: 'listing',
                        link: '/search/listing',
                        state: { keyword: "locations", keywordId: 4 }
                    },
                    {
                        name: 'location-profile',
                        link: '/search/listing/location'
                    },
                ]} />
                <div className='row'>
                                ...
                                >
                                    {otherProfilesFromSeller?.otherProfiles?.map((data, i) => (
                                        <SwiperSlide key={i} className="h-unset">
                                            <Location profile={data} key={i} index={i} otherProfile={true} />
                                        </SwiperSlide>
                                    ))}
                                </Swiper>
                            </div>
...
export default IsLoadingHOC(LocationProfile)
