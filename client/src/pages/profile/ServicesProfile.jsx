...
const ServicesProfile = ({ setLoading }) => {
    const { otherServicesListing, dispatchSearch } = useSearchContext()
    // hooks
    ...
    const toggleWishServicesList = (index, profileId, profileType) => {
        if (otherServicesListing[index]?.wishlistProfile) {
            dispatch(deleteWishlistItem(otherServicesListing[index]?.wishlistItemId))
            let temp = [...otherServicesListing]
            ...
            <Container>
                ...
                <CurrentDirectorylink className={'my-3'} routeData={[
                    ...
                    },
                    {
                        name: 'listing',
                        link: '/search/listing',
                        state: { keyword: "services", keywordId: 3 }
                    },
                    {
                        name: 'services-profile',
                        link: '/search/listing/services'
                    },
                ]} />
                <div className='row'>
                                ...
                                >
                                    {otherProfilesFromSeller?.otherProfiles?.map((data, i) => (
                                        <SwiperSlide key={i} className="h-unset">
                                            <Service profile={data} key={i} index={i} otherProfile={true} />
                                        </SwiperSlide>
                                    ))}
                                </Swiper>
                            </div>
...
export default IsLoadingHOC(ServicesProfile)
