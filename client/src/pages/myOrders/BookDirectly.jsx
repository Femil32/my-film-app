...
const BookDirectly = ({ setLoading }) => {
    ...
    const postAvailabilityCheck = () => {
        ...
        dispatch(AddOrder({ payload, navigation }))
    }
                    ...
                    </div>
                    {
                        profileCost?.profileCosts?.map((cost, i) => {
                            return cost?.rateType === projectType?.rateType && <div key={i}>
                                ...
                                <ButtonTag classes={'btn-orange semibold fn-12 rounded w-100 mt-4'} value={'Book Now'} onClick={() => {
...
export default IsLoadingHOC(BookDirectly)